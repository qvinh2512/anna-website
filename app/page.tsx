...
<div className="flex justify-center mb-8">
  ...
  />
            ...
            <a href="https://www.facebook.com/anna.duyen.an" target="_blank"
  className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors shadow-lg shadow-blue-900/50">
