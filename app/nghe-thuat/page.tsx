...
export default async function NgheThuatPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      <div className="mb-10">
        <p className="text-green-600 text-xs tracking-widest uppercase mb-2">Hội họa · Triển lãm · Sáng tạo</p>
        <h1 className="text-4xl mb-3" style={{fontFamily:"'Playfair Display',serif"}}>
          🎨 Nghệ <em>Thuật</em>
        </h1>
        <p className="text-gray-500">Hội họa sơn dầu, triển lãm và những sáng tạo nghệ thuật của Anna.</p>
      </div>
